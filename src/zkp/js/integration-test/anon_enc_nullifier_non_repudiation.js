...
const { Poseidon, newSalt, loadCircuit } = require('../index.ts');
...
describe('main circuit tests for Zeto fungible tokens with encryption fro non-repudiation and anonymity using nullifiers', () => {
  ...
  before(async () => {
    ...
    ({ provingKeyFile, verificationKey } = loadProvingKeys('anon_enc_nullifier_non_repudiation'));
